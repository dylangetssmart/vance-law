...
--    party_id as PartyID,    
--case
--    when P.Marital_Status='Significant Other' then (select mtsnMaritalStatusID FROM [VanceLawFirm_SA].[dbo].[sma_MST_MaritalStatus] where mtssDscrptn = 'Other')
--    else (select mtsnMaritalStatusID FROM [VanceLawFirm_SA].[dbo].[sma_MST_MaritalStatus] where mtssDscrptn = P.Marital_Status)
--end	   as StatusID
