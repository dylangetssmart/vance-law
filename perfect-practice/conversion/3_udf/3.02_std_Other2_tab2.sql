...
-- Dynamically get all columns from TestNeedles..user_tab2_data for unpivoting
...
FROM ( 
    ...
    FROM TestNeedles..user_tab2_data ud
...
select * from TestNeedles..user_tab2_data
...
FROM [sma_MST_CaseType] CST
	...
	JOIN [TestNeedles].[dbo].[user_tab2_matter] M
