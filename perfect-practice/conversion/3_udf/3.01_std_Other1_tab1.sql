...
-- Dynamically get all columns from TestNeedles..user_tab1_data for unpivoting
...
FROM ( 
    ...
    FROM TestNeedles..user_tab1_data ud
...
select * from TestNeedles..user_tab1_data
...
FROM [sma_MST_CaseType] CST
	...
	JOIN [TestNeedles].[dbo].[user_tab1_matter] M
