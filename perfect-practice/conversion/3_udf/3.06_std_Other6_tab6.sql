/* ########################################################
This script populates UDF Other6 with all columns from user_tab6_data
*/
...
-- Dynamically get all columns from TestNeedles..user_tab6_data for unpivoting
...
FROM ( 
    ...
    FROM TestNeedles..user_tab6_data ud
...
select * from Other6udf
select * from TestNeedles..user_tab6_data
...
FROM [sma_MST_CaseType] CST
	...
	JOIN [TestNeedles].[dbo].[user_tab6_matter] M
