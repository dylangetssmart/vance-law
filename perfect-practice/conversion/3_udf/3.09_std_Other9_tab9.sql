...
-- Dynamically get all columns from TestNeedles..user_tab9_data for unpivoting
...
FROM ( 
    ...
    FROM TestNeedles..user_tab9_data ud
...
select * from Other9udf
select * from TestNeedles..user_tab9_data
...
FROM [sma_MST_CaseType] CST
	...
	JOIN [TestNeedles].[dbo].[user_tab9_matter] M
