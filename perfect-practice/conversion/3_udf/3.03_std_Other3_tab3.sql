/* ########################################################
This script populates UDF Other3 with all columns from user_tab3_data
*/
...
-- Dynamically get all columns from TestNeedles..user_tab3_data for unpivoting
...
FROM ( 
    ...
    FROM TestNeedles..user_tab3_data ud
...
select * from Other3udf
select * from TestNeedles..user_tab3_data
...
FROM [sma_MST_CaseType] CST
	...
	JOIN [TestNeedles].[dbo].[user_tab3_matter] M
