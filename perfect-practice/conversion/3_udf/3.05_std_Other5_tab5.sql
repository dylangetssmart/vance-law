...
-- Dynamically get all columns from TestNeedles..user_tab5_data for unpivoting
...
FROM ( 
    ...
    FROM TestNeedles..user_tab5_data ud
...
select * from Other5udf
select * from TestNeedles..user_tab5_data
...
FROM [sma_MST_CaseType] CST
	...
	JOIN [TestNeedles].[dbo].[user_tab5_matter] M
