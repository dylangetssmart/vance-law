...
-- Dynamically get all columns from TestNeedles..user_tab10_data for unpivoting
...
FROM ( 
    ...
    FROM TestNeedles..user_tab10_data ud
...
select * from TestNeedles..user_tab10_data
...
FROM [sma_MST_CaseType] CST
	...
	JOIN [TestNeedles].[dbo].[user_tab10_matter] M
