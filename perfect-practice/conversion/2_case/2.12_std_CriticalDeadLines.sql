...
insert into [sma_MST_CriticalDeadlineTypes] (
	...
	,1 from TestNeedles.[dbo].[Matter] M where isnull(dbo.GMACaseDate(M.case_date_1), '') <> ''

union
	
	select distinct dbo.GMACaseDate(M.case_date_2)
	,1 from TestNeedles.[dbo].[Matter] M where isnull(dbo.GMACaseDate(M.case_date_2), '') <> ''

union
	
	select distinct dbo.GMACaseDate(M.case_date_3)
	,1 from TestNeedles.[dbo].[Matter] M where isnull(dbo.GMACaseDate(M.case_date_3), '') <> ''

union
	
	select distinct dbo.GMACaseDate(M.case_date_4)
	,1 from TestNeedles.[dbo].[Matter] M where isnull(dbo.GMACaseDate(M.case_date_4), '') <> ''

union
	
	select distinct dbo.GMACaseDate(M.case_date_5)
	,1 from TestNeedles.[dbo].[Matter] M where isnull(dbo.GMACaseDate(M.case_date_5), '') <> ''

union
	
	select distinct dbo.GMACaseDate(M.case_date_6)
	,1 from TestNeedles.[dbo].[Matter] M where isnull(dbo.GMACaseDate(M.case_date_6), '') <> ''

union
	
	select distinct dbo.GMACaseDate(M.case_date_7)
	,1 from TestNeedles.[dbo].[Matter] M where isnull(dbo.GMACaseDate(M.case_date_7), '') <> ''

union
	
	select distinct dbo.GMACaseDate(M.case_date_8)
	,1 from TestNeedles.[dbo].[Matter] M where isnull(dbo.GMACaseDate(M.case_date_8), '') <> ''

union
	
	select distinct dbo.GMACaseDate(M.case_date_9)
	,1 from TestNeedles.[dbo].[Matter] M where isnull(dbo.GMACaseDate(M.case_date_9), '') <> ''
)
