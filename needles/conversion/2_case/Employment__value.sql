...
-- select
-- 	*
-- from [VanceLawFirm_Needles]..value v
-- where
-- 	code = 'lwg'
...
-- select
-- 	*
-- from [VanceLawFirm_Needles]..provider p
-- where
-- 	p.name_id = 4386
...
-- select
-- 	*
-- from [VanceLawFirm_Needles]..names n
-- where
-- 	n.names_id = 4386
...
-- select
-- 	*
-- from [VanceLawFirm_Needles]..party p
...
-- join [VanceLawFirm_Needles]..provider p
