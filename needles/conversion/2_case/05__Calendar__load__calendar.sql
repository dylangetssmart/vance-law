...
from Skolrood_Needles.[dbo].[calendar] cal
...
insert into [sma_trn_AppointmentStaff]
	...
	join Skolrood_Needles.[dbo].[calendar] cal
...
/*
----(3)-----
insert into [Skolrood_SA].[dbo].[sma_trn_AppointmentStaff] ( [AppointmentId] ,[StaffContactId] ) 
select APP.AppointmentID, MAP.Party_Contact
from [Skolrood_SA].[dbo].[sma_TRN_CalendarAppointments] APP
inner join Skolrood_Needles.[dbo].[calendar] CAL on APP.saga='Case-related:'+convert(varchar,CAL.calendar_id)
