...
-- Dynamically get all columns from JoelBieberNeedles..user_tab5_data for unpivoting
...
FROM ( 
    ...
    FROM JoelBieberNeedles..user_tab5_data ud
...
BEGIN
	INSERT INTO [sma_MST_UDFDefinition]
	   ...
	   ,[udfnSortOrder]
		...
		JOIN [JoelBieberNeedles].[dbo].[user_tab5_matter] M
