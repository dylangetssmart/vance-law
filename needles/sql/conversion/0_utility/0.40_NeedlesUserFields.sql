...
FROM VanceLawFirm_Needles..[user_case_fields]
...
BEGIN
	...
	INTO #values
	FROM VanceLawFirm_Needles..mini_general_dir gd
	JOIN VanceLawFirm_Needles..mini_dir_list dl on gd.num_assigned = dl.dir_key
