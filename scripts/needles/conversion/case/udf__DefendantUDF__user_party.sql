/*
description: >
  Populates DefendantUDF with fields from user_party_data for Defendant roles.
...
steps: |
  ...
  4. Create [VanceLawFirm_SA].[DefendantUDF] (unpivoted pivot table for UDF values)
...
[#ExcludedColumns] -- Temp table to exclude specific columns
	- Use this to define any columns that should be excluded from the Defendant UDF insert
*/ ------------------------------------------------------------------------------
...
[SA].[conversion].[FieldTitleMap] -- Field Title Mapping Table
	...
	- Filters out non-defendant user fields 
