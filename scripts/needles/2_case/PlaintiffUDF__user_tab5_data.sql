...
declare @TableName SYSNAME = 'user_tab5_data'; -- source EAV table
...
-------------------------------------------------------------------------------
if OBJECT_ID('user_tab5_data_pivoted') is not null
	drop table user_tab5_data_pivoted;
...
select
	...
	nuf.column_name,
	nuf.DropDownValues
into user_tab5_data_pivoted
from ##Pivoted_Data pv
join [VanceLawFirm_Needles].[dbo].NeedlesUserFields nuf
	on nuf.column_name = pv.Attribute
		and nuf.table_name = 'user_tab5_data'
left join [VanceLawFirm_Needles].[dbo].user_tab5_name utn
...
-- Final output
select * from dbo.user_tab5_data_pivoted; -- verify results
...
insert into [sma_MST_UDFDefinition]
	...
	--select *
	from user_tab5_data_pivoted pe
